...
2.  Dump the data from your source database in tab separated or CSV format.
3.  Create the tables on TiDB based on the statements you created.
4.  Load the data with `LOAD DATA INFILE` or TiDB Lightning into the tables.
